#ifndef UNIFORMRANDOMSELECTOR_H
#define UNIFORMRANDOMSELECTOR_H
...
public:
	 ...
	 */
	UniformRandomSelector() : counter(1) {};
	...
	bool add_element() {
		++counter;
		return (Random::real() < 1.0 / counter);
	}
